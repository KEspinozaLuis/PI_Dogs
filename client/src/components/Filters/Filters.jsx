...
import { 
    ...
    orderByName, 
    orderByWeight,
    clearFilters} from '../../redux/actions'
        ...
        <div className={`${styles.containerFilters} container`}>
            ...
            <div className={styles.contentFilters}>
                ...
                <div className={styles.buttonFilters}>
                    <select id="name" onChange={handleOrderName} defaultValue='name'>
                        <option value="name" disabled>Name</option>
                        <option value="ascName">Ascending</option>
                        <option value="desName">Descending</option>
                    </select>
                    <select id="weight" onChange={handleOrderWeight} defaultValue='weight'>
            ...
            <div className={styles.contentFilters}>
                ...
                <div className={styles.buttonFilters}>
                    ...
                    <button onClick={handleFilterDogs} id='api' className={`${styles.btnFilter} btn`}>API</button>
                    <button onClick={handleFilterDogs} id='bd' className={`${styles.btnFilter} btn`}>MY DOGS</button>
                    <select id="temperaments" onChange={handleFilterTemperaments} defaultValue='temperaments'>
                    ...
                    <button onClick={handleClearFilters} className={`${styles.btnFilter} btn`}>CLEAR</button>
                </div>
            </div>
        </div>
    )
